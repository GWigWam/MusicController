            ...
            return new SpeechCommand[] {
                ...
                new SpeechCommand() {
                    ...
                    Execute = (sentence) => {
                        ...
                        speechController.Playlist.PlayAllMatches(s => s.Title.Equals(songName, StringComparison.CurrentCultureIgnoreCase));
                        return new string[0];
                    },
                    CanExecute = () => speechController.Settings.EnableSpeech
                },
                ...
                new SpeechCommand() {
                    ...
                    Execute = (sentence) => {
                        ...
                        speechController.Playlist.PlayAllMatches(s => s.Album.Equals(albumName, StringComparison.CurrentCultureIgnoreCase));
                        return new string[0];
                    },
                    CanExecute = () => speechController.Settings.EnableSpeech
                },
                ...
                new SpeechCommand() {
                    ...
                    Execute = (sentence) => {
                        ...
                        speechController.Playlist.PlayAllMatches(s => s.Artist.Equals(artistName, StringComparison.CurrentCultureIgnoreCase));
                        return new string[0];
                    },
                    CanExecute = () => speechController.Settings.EnableSpeech
                },
